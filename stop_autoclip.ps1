...
function Stop-ProjectProcesses {
    ...
    foreach ($proc in $allProcesses) {
        ...
        if ($proc.MainWindowTitle -match "autoclip|auto.?clip") {
            $shouldStop = $true
        }
        ...
        if ($shouldStop) {
            Write-Log "Found AutoClip process: $($proc.ProcessName) (PID: $($proc.Id))" "WARNING"
            Stop-ProcessSafely -ProcessId $proc.Id -ServiceName "AutoClip process"
        }
    }
}
...
Write-Host ""
Write-Host "==============================================="
Write-Host "     AutoClip Service Stop Script              "
Write-Host "==============================================="
Write-Host ""
