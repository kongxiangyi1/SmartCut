...
const PipelineControl: React.FC<PipelineControlProps> = ({ 
  ...
  const fetchPipelineStatus = async () => {
    try {
      ...
      const response = await fetch(`${API_CONFIG.fullApiUrl}/pipeline/status/${projectId}`);
      if (!response.ok) {
  ...
  const startPipeline = async () => {
    try {
      ...
      const response = await fetch(`${API_CONFIG.fullApiUrl}/pipeline/start/${projectId}`, {
        method: 'POST'
      });
  ...
  const stopPipeline = async () => {
    try {
      ...
      const response = await fetch(`${API_CONFIG.fullApiUrl}/pipeline/stop/${projectId}`, {
        method: 'POST'
      });
  ...
  const restartPipeline = async () => {
    try {
      ...
      const response = await fetch(`${API_CONFIG.fullApiUrl}/pipeline/restart/${projectId}`, {
        method: 'POST'
      });
