        ...
        for clip in clips_with_titles:
            for processed_clip in processed_clips_data:
                if processed_clip['id'] == clip['id']:
                    clip['start_time'] = processed_clip.get('start_time', clip['start_time'])
                    clip['end_time'] = processed_clip.get('end_time', clip['end_time'])
                    clip['original_start_time'] = processed_clip.get('original_start', clip.get('original_start', clip['start_time']))
                    clip['original_end_time'] = processed_clip.get('original_end', clip.get('original_end', clip['end_time']))
                    break
