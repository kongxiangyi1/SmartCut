...
async def get_clip_content(
    ...
    try:
        ...
        if not clip:
            ...
            raise HTTPException(status_code=404, detail="切片不存")
        ...
        if not content:
            ...
            raise HTTPException(status_code=404, detail="切片内容不存")
...
async def get_collection_content(
    ...
    try:
        ...
        if not collection:
            ...
            raise HTTPException(status_code=404, detail="合集不存")
        ...
        if not content:
            ...
            raise HTTPException(status_code=404, detail="合集内容不存")
...
async def download_clip_file(
    ...
    try:
        ...
        if not clip.video_path:
            ...
            raise HTTPException(status_code=404, detail="切片文件不存")
    ...
    try:
        ...
        return FileResponse(
            ...
            headers={
                ...
                "Accept-Ranges": "bytes",  # 支持范围请求，便于视频播"
...
async def download_collection_file(
    ...
    try:
        ...
        if not collection.export_path:
            ...
            raise HTTPException(status_code=404, detail="合集文件不存")
...
async def get_project_collection_video(
    ...
    try:
        ...
        # 注意：这里假设Collection模型有project_id字段，如果没有需要调"
...
async def cleanup_project_files(
    ...
    try:
        ...
        return {
            ...
            "message": f"项目 {project_id} 旧文件清理完"
