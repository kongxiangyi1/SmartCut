...
class ClipResponse(BaseSchema):
    ...
    start_time: Optional[float] = Field(description="Start time in seconds (with millisecond precision)")
    end_time: Optional[float] = Field(description="End time in seconds (with millisecond precision)")
    duration: Optional[float] = Field(description="Clip duration in seconds (with millisecond precision)")
